...
namespace Social_Fe
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            SocialBlInjector.Register(container);
            container.RegisterSingleton<IAmazonS3Uploader, AmazonS3Uploader>();
            container.RegisterSingleton<ICommentsManager, CommentsManager>();
            container.RegisterSingleton<ILikesManager, LikesManager>();
